 ...
 */
public interface VideoScanService extends IService<VideoScan> {
     ...
     * @param pageSize 每页数量
     */
    AjaxResult selectPage(Integer pageNow, Integer pageSize,String videoName, String seriesName, String videoType);
